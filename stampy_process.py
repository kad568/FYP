...
def run_sim(input_dex: InputeDex):
    ...
    # delete .stt file
    file_to_remove = "stamping_sim.stt"
...
def cylindrical_cup_function(ideal_cup_height, ideal_cup_radius, ideal_cup_profile_radius, punch_depth, BHF, friction,
    ...
    input_dex.friction_coefficient = friction
    input_dex.BHF = BHF / 4

    # mesh
    input_dex.mesh_size = 2
    input_dex.local_mesh_size = 2 * 0.33

    input_dex_set = [input_dex]

    main_sim_output =  r"C:\Users\kam97\OneDrive - University of Bath\Documents\build\process_optimisation2\sim_runs/1"
